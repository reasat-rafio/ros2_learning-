...
bool my_robot_interfaces__msg__hard_ware_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_interfaces.msg._hard_ware_status.HardWareStatus", full_classname_dest, 56) == 0);
  }
...
PyObject * my_robot_interfaces__msg__hard_ware_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_interfaces.msg._hard_ware_status");
