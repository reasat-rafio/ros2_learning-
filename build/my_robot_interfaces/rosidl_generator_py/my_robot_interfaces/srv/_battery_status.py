...
class Metaclass_BatteryStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.srv.BatteryStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_robot_interfaces.srv import _battery_status
...
class BatteryStatus(metaclass=Metaclass_BatteryStatus):
    from my_robot_interfaces.srv._battery_status import BatteryStatus_Request as Request
    from my_robot_interfaces.srv._battery_status import BatteryStatus_Response as Response
