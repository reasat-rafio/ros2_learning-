...
bool my_robot_interfaces__msg__led_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // led_status
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->led_status.data;
...
PyObject * my_robot_interfaces__msg__led_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // led_status
    ...
    if (ros_message->led_status.size > 0) {
      ...
      int32_t * src = &(ros_message->led_status.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->led_status.size * sizeof(int32_t));
      assert(data != NULL);
